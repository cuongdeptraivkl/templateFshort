...
// click color and background header
var li_menu_header = document.querySelectorAll(".li_menu_header");
var acolor = document.querySelector("#acolor");
for (let i ; i < li_menu_header.length; i++){
  li_menu_header[i].addEventListener("click", ()=>{
    acolor.style.border = "1px solid rgba(128, 128, 128, 0.473)";
    acolor.style.color = "rgb(37, 37, 37)";
  })
}