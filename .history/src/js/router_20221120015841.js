...
function Video_home(dataabouthome) {
  let ListaboutHome = document.querySelector(".links_video");
  ...
  for (let item of dataabouthome) {
    ...
    <div class="links_video">
        <img src="https://scontent.fhan2-5.fna.fbcdn.net/v/t39.30808-6/313347520_1069237247086088_8949704310338389666_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=b7yS7oJT7lEAX92Jdts&_nc_ht=scontent.fhan2-5.fna&oh=00_AfA6wXH0pL3HnfosLZUQOQ5ZEEzcL1RW8_8u86tdcaE1eA&oe=6379CCB7" width="50%" alt="">
    </div>
    <div class="feeling">
