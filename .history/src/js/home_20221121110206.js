       ...
       ListVideouser.innerHTML += `
              <div class="video_user_detail" >
                          ...
                          <div class="views_video_user_detail d-flex align-items-center">
                            <i class='bx bx-play fs-4'></i><span class="view_video">23</span>
                          </div>
                        </div>`;
     }
   }
...
var clickvideoid = document.querySelector(".Post_video_user_detail");
var valueviewvideo = Array(clickvideoid);
console.log(valueviewvideo);
  for (let i = 0; i < clickvideoid.length; i++) {
    console.log(clickvideoid[i]);
    clickvideoid[i].addEventListener("click", ()=>{
         valueviewvideo++;
         clickvideoid["span"].innerHTML = valueviewvideo;
      })
    }
