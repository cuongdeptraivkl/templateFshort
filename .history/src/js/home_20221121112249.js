       ...
       ListVideouser.innerHTML += `
              <div class="video_user_detail" >
                          ...
                          <div class="views_video_user_detail d-flex align-items-center">
                            <i class='bx bx-play fs-4'></i><span class="view_video">33</span>
                          </div>
                        </div>`;
     }
   }
...
var clickvideoid = document.querySelectorAll(".Post_video_user_detail");
var valueviewvideo = 0;
var arrvideoview = Array(clickvideoid);
console.log(arrvideoview[0][innerHTML]);
var valuespan = document.querySelector(".view_video");

for (let i = 0; i < clickvideoid.length; i++) {
  // console.log(clickvideoid["div"]);
  clickvideoid[i].addEventListener("click", ()=>{
       valueviewvideo++;
       valuespan.innerHTML = valueviewvideo;
    })
  };
