...
// even follow user other
   ...
   let followdetailother = "follow";
function follow(btn) {
  var follow = btn.dataset.follow;
  // console.log(btn.dataset.follow);
  if (Number(follow)) {
    followdetailother.innerHTML = "Đang Follow";
    followdetailother.style.backgroundColor = "white";
    followdetailother.style.color = "#ff3b5c";
    followdetailother.style.border = "2px solid #ff3b5c";
    ...
    if (checkFL == false) {
      ...
      btn.innerHTML = "Follow";
            btn.style.backgroundColor = "#ff3b5c";
