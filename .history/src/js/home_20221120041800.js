...
///////////////////// scroll play video//////////////////////
var videoshome = document.querySelector(".links_video");

if (videoshome) {
    var videoshometagname = document.getElementsByTagName("video");
}

function checkScroll() {
  var fraction = 0.7; // Play when 80% of the player is visible.

  for (var i = 0; i < videoshometagname.length; i++) {
    var videohome = videoshometagname[i];

    var x = videohome.offsetLeft,
      y = videohome.offsetTop,
      w = videohome.offsetWidth,
      h = videohome.offsetHeight,
      r = x + w, //right
      b = y + h, //bottom
      visibleX,
      visibleY,
